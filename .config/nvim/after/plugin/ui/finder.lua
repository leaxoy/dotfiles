...
map("n", "fdc", extensions.dap.configurations, { desc = "Dap: Configurations" })
map("n", "fdf", extensions.dap.frames, { desc = "Dap: Frames" })
map("n", "fdv", extensions.dap.variables, { desc = "Dap: Variables" })
